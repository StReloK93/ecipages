      ...
      <section v-else>
         <IconField class="mb-4">
            ...
            <InputText
               ...
               placeholder="Qidiruv"
               fluid
               class="rounded-xl! border border-surface-100! shadow-none!"
            />
         </IconField>
         <main class="max-h-90 overflow-y-auto flex flex-col gap-2">
            <div
               ...
               class="rounded-xl py-2 px-4 bg-white border border-surface-100 cursor-grab active:cursor-grabbing hover:bg-blue-50 hover:border-blue-300 transition-all flex items-center gap-3"
            >
